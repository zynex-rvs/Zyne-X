        ...
        <div className="hidden lg:flex items-center gap-4">
          {currentUser && (
            ...
            >
              ...
              {unreadCount > 0 && (
                <span className="absolute top-0 right-0 w-4 h-4 bg-white/10 text-[9px] font-bold rounded-full flex items-center justify-center text-white border border-white/10 shadow-lg">
                  {unreadCount}
                </span>
              )}
            </div>
