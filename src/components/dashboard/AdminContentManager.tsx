    ...
    return (
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1">
          ...
          >
            {formData.image && (
              <div className="relative group w-16 h-16 cursor-pointer flex-shrink-0">
                <img src={formData.image} alt="Preview" className="w-full h-full rounded-md object-cover border border-white/10" />
                <div 
                  className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 flex items-center justify-center rounded-md transition-opacity"
                  onClick={(e) => { e.stopPropagation(); setCropperImage(formData.image); }}
                  title="Edit Image"
                >
