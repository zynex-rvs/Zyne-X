      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div
            ...
            className="bg-[#0f172a] max-h-[85dvh] overflow-y-auto border border-green-500/30 rounded-2xl p-8 max-w-md w-full relative z-10 shadow-[0_0_30px_rgba(34,197,94,0.15)] flex flex-col items-center text-center"
          >
            <button
              onClick={onClose}
